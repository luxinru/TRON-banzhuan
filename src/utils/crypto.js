export default function getCryptoData (type,cb) {
  ...
  let typeArr = ['bitcoin','ethereum','bnb','tron','dogecoin','litecoin','xrp','cardano','solana','apecoin-ape','cosmos']
  let rtype = typeArr[Math.floor(Math.random(0,1) * 10)]
  // if (!rtype) {
  //   rtype = 'bitcoin'
  // }
  ...
  fetch('https://api.coinmarketcap.com/data-api/v3/cryptocurrency/market-pairs/latest?slug='+ rtype+ '&start=1&limit='+limit+ '&category=spot&sort=cmc_rank_advanced', options)
