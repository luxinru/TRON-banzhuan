<template>
  ...
  <div class="page_root">
    <section class="topbar" style="top: 0;
    position: fixed;">
      <van-icon class="icon" name="arrow-left" color="#060606" @click="$router.go(-1)" />
      <span>TRX/USDT Swap</span>
    </section>
    <div class="sc-16r8icm-0 tu1guj-1" @click="$router.push('/my-invests')"> <img style="width: 50px;"
        src="@/assets/images/alpha/notes2.png" alt=""></div>
    <div class="list">
...
<!--        <div class="info">
        ...
        <div class="info">
          ...
          <span>{{ item.day }}{{ $t('day') }}  ≈ +{{ (item.rate * item.day).toFixed(2) || 0 }}%</span>
        </div>
<!--        <div class="info">
    ...
    <van-dialog class="dialog" v-model="isShowModel" closeOnClickOverlay :showConfirmButton="false">
      <div class="content">
        ...
        <div class="currency_slider_item item" v-for="(item, index) in record" :key="index">
          <div class="currency_slider_item_top">
            <span style="font-size: 14px;font-weight: 700;" v-if="item.type == 1">USDT: <span
                style="color: firebrick;">{{item.money}}</span> / TRX :{{item.money1}} </span>
            <span style="font-size: 14px;font-weight: 700;" v-if="item.type == 2">USDT: <span
                style="color: firebrick;">{{item.money1}}</span> / TRX :{{item.money}} </span>
          </div>
        </div>
      </div>
    </van-dialog>
    ...
    top: 100px;">
      ...
      <section class="funs-trade">
        <div class="currency_slider_item item">
          <div class="currency_slider_item_top">
            ...
            <span class="color-00004 fs-12 fw-500"><img style=" margin-left:20px; 25px;" @click="getRecord"
                src="@/assets/images/alpha/document.png" alt="" /></span>
          </div>
          <div class="currency_slider_item_bottom">

            <div class="fs-22 fw-250">
              <span balances_ps="100"
                style="font-family: PingFang SC;font-weight: 400;color: #8f8f8f;text-decoration: none;font-weight: 500;">{{usdt}}USDT
              </span>
        ...
        <div class="currency_slider_item item">
          <div class="currency_slider_item_top">
            ...
            <span class="color-00004 fs-12 fw-500"><img @click="getRecord" style=" margin-left:20px; 25px;"
                src="@/assets/images/alpha/document.png" alt="" /></span>
          </div>
          <div class="currency_slider_item_bottom">
            ...
            <div class="fs-22 fw-250">
              <span balances_ps="100"
                style="font-family: PingFang SC;font-weight: 400;color: #8f8f8f;text-decoration: none;font-weight: 500;">{{trx}}TRX
              </span>
              <span class="color-00004 fs-12 fw-500">USD {{price_in_usd*trx}}</span>
      ...
      <button class="x0o17e-0 lgnbfA piv2lb-0 khvEXx newsletter-btn" style="width: 49%;" @click="U2Trx()">Buy TRX
      </button>
      <button class="x0o17e-0 lgnbfA piv2lb-0 khvEXx newsletter-btn" style="width: 49%;float: right;"
        @click="Trx2U()">Sell TRX</button>
